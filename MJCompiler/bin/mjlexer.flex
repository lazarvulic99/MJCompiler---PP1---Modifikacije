...
"nizmajmun"	{ return new_symbol(sym.NIZMAJMUN, yytext()); }
...
"?"			{ return new_symbol(sym.NOVITERNARNI, yytext()); }
"??"		{ return new_symbol(sym.TERNARNI, yytext()); }
"@"			{ return new_symbol(sym.MAJMUN, yytext()); }
"@@"		{ return new_symbol(sym.MAJMUNMAJMUN, yytext()); }
"~"			{ return new_symbol(sym.TILDAZANIZ, yytext()); }
"^"			{ return new_symbol(sym.BOCNIEFEKAT, yytext()); }
"^^"		{ return new_symbol(sym.BINARNINIZ, yytext()); }
"#"			{ return new_symbol(sym.MAX, yytext()); }
"##"		{ return new_symbol(sym.KVADRIRAJ, yytext()); }
"!"			{ return new_symbol(sym.FAKTORIJEL, yytext()); }
