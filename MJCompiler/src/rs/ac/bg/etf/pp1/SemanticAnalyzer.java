...
public class SemanticAnalyzer extends VisitorAdaptor {
	...
	public boolean proveriJeLiInt(Expr expr) {
		if(expr.struct.equals(Tab.intType) == true) {
			return true;
		}else {
			return false;
	...
	public void visit(DesignatorStatement_ternarni DesignatorStatement_ternarni) {
		Expr preZnakaPitanja = DesignatorStatement_ternarni.getExpr();
		Expr expr1 = DesignatorStatement_ternarni.getExpr1();
		Expr expr2 = DesignatorStatement_ternarni.getExpr2();
		if(proveriJeLiInt(preZnakaPitanja) == false) {
			report_error("GRESKA(DesignatorStatement_ternarni)! Pre znaka pitanja mora biti int!", DesignatorStatement_ternarni);
		}
		if(expr1.struct.assignableTo(DesignatorStatement_ternarni.getDesignator().obj.getType()) == false) {
			report_error("GRESKA(DesignatorStatement_ternarni)! Prvi moguci mora biti assignable u designator!", DesignatorStatement_ternarni);
		}
		if(expr2.struct.assignableTo(DesignatorStatement_ternarni.getDesignator().obj.getType()) == false) {
			report_error("GRESKA(DesignatorStatement_ternarni)! Drugi moguci mora biti assignable u designator!", DesignatorStatement_ternarni);
		}
	}
