...
public class ProgDeclList_const extends ProgDeclList {

    private ProgDeclList ProgDeclList;
    private ConstDeclList ConstDeclList;

    public ProgDeclList_const (ProgDeclList ProgDeclList, ConstDeclList ConstDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ProgDeclList_const(\n");
