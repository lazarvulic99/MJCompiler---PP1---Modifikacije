...
public class DesignatorStatement_dodela extends DesignatorStatement {

    private Designator Designator;
    private AssignOperator AssignOperator;
    private Expr Expr;

    public DesignatorStatement_dodela (Designator Designator, AssignOperator AssignOperator, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatement_dodela(\n");
